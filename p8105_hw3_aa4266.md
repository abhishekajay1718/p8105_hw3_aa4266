...
We multiply the precipitation, minimun temperature and maximum temperature by 10 since all these values are given in tenths of their units (mm, degree celsius, degree celsius respectively) in the noaa dataset.
